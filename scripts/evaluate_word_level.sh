...
CUDA_VISIBLE_DEVICES=$device OMP_NUM_THREADS=$num_threads python -m joeynmt translate $configs/$model_name.yaml < $test.tokenized.en-de.$src > $translations_sub/test.wordlevel.$model_name.$trg
